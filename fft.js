...
var username, password, delay, target, comments;
          ...
          return Client.Relationship.create(gSession, following[i].id).then(function (resp) {
            ...
            return _userMedia()
              .then(function (media) {
                ...
                Client.Comment.create(gSession, media[0].id, sample(comments))
                  .then(function (resp) {
